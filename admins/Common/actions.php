		...
		<div class="profile_info">
			...
			<div class="actions">
				<ul>
					...
					<li id="buses">
						<i class="fa fa-bus" style="font-size: 30px;color:#CDEF25"></i>
						<a href="../admin/buses.php">Buses</a>
					</li>

					<li id="route">
						<i class='fa fa-road' style='font-size:25px;color:#CDEF25'></i>
						<a href="../admin/routes.php">Routes</a>
					</li>

					<li id="customer">
						<i class="fa fa-group" style="font-size:25px;color:#CDEF25"></i>
						<a href="../admin/customers.php">Customers</a>
					</li>

					<li id="booking">
						<i class="fa fa-book" style="font-size:30px;color:#CDEF25"></i>
						<a href="../admin/bookings.php">Bookings</a>
					</li>

					<li id="admin">
						<i class="fa fa-user" style="font-size:22px;color:#CDEF25"><b>+</b></i>
						<a href="create_user.php">Add New Admin</a>
					</li>

					<li id="users">
						<i class="fa fa-eye" style="font-size:30px;color:#CDEF25"></i>
